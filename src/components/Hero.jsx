    ...
    >
      <div className="container mx-auto px-4 z-10 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mt-16 flex justify-center space-x-8 text-text-primary">
            <div className="text-center">
              <div className="text-3xl font-bold text-accent-primary">10k+</div>
              <div className="text-sm text-text-secondary">Active Members</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-accent-secondary">$2.5M</div>
              <div className="text-sm text-text-secondary">Saved Together</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-accent-tertiary">500+</div>
              <div className="text-sm text-text-secondary">Communities</div>
            </div>
          </div>
        </div>
      </div>
